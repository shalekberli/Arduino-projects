...
bool isDisplayTime(unsigned long currentTime) {
...
bool isPageChangeTime(unsigned long currentTime) {
...
//      Serial.print("msg count str length = "); Serial.println(strTemp.length());
//      
