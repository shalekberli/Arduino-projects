...
void loop(){
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    if (esc_1 < 800) esc_1 = 800;                                         //Keep the motors running.
    if (esc_2 < 800) esc_2 = 800;                                         //Keep the motors running.
    if (esc_3 < 800) esc_3 = 800;                                         //Keep the motors running.
    if (esc_4 < 800) esc_4 = 800;                                         //Keep the motors running.
